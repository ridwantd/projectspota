...
<html lang="en" class="no-js">
			...
			<div class="main-content">
				<div class="container">
					...
					switch ($_GET['page']){
						...
						case 'outline':
							include "page/outline/outline.php";
						break;
	...
	switch ($_GET['page']){
		default:
			include "../assets/js/mhs/_dashboard.php";
		break;

		case 'user':
			include "../assets/js/mhs/_user.php";
		break;

		case 'praoutline':
			include "../assets/js/mhs/_praoutline.php";
		break;

		case 'outline':
			include "../assets/js/mhs/_outline.php";
		break;

		case 'pengumuman':
			include "../assets/js/mhs/_pengumuman.php";
		break;

		/*case 'pengaturan':
			include "../assets/js/mhs/_pengaturan.php";
		break;*/
